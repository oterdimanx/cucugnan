                    ...
                    <div className="row gx-5 align-items-center">
                        ...
                        <div className="col-lg-6">
                            ...
                            <p className="regular text-muted mb-0 text-gite">
                                ...
                                Aux pieds du dernier bastion Cathare, le château de Queribus.
                            </p>
                            <p className="regular text-muted mb-0 text-gite">
                                Il est idéalement situé pour partir 
                ...
                <div className="container px-5 my-5">
                    <div className="row gx-5 align-items-center">
                        ...
                        <div className="col-lg-6">
                            ...
                            <a className="btn btn-secondary btn-lg btn-gite" href="./contact">
                                Contactez-nous
                            </a>
                        </div>
                    </div>
