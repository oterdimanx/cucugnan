export default function Header({ title }) {
  return <nav className="navbar navbar-expand-lg navbar-dark bg-dark-purple">
  <div className="container px-5">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item"><a className="nav-link" href="./nos-produits">Nos Produits</a></li>
              <li className="nav-item"><a className="nav-link" href="./contact">Contact</a></li>
              <li className="nav-item"><a className="nav-link" href="./gite">Gîte</a></li>
              {/**
